...
from reflow.data_loaders_copy_test import get_data_loaders
from reflow.vocoder_copy_test import Vocoder, Unit2Wav
...
if __name__ == '__main__':
    ...
    if args.model.type == 'RectifiedFlow':
        from reflow.solver_copy_test import train
        model = Unit2Wav(
