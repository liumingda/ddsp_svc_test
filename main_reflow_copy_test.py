...
from ddsp.vocoder_copy_test import load_model, F0_Extractor, Volume_Extractor, Units_Encoder
from ddsp.core import upsample
from reflow.vocoder_copy_test import load_model_vocoder
from tqdm import tqdm
from spk_embedding_model.espnet.espnet2.bin.spk_inference import Speech2Embedding
import torchaudio
...
if __name__ == '__main__':
    ...
    speech2spk_embed = Speech2Embedding(model_file="D:/liumingda/SVC/code/versa/voxcelebs12_rawnet3/save_exp/spk_train_rawnet3_best_trnVox12_emb192_amp_subcentertopk_raw_sp/40epoch.pth", train_config="D:/liumingda/SVC/code/versa/voxcelebs12_rawnet3/save_exp/spk_train_rawnet3_best_trnVox12_emb192_amp_subcentertopk_raw_sp/config.yaml")
