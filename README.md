...
python train_reflow_copy_test.py -c configs/reflow.yaml
```
...
python main_reflow_copy_test.py -i ./raw/壁上观_0.wav -m ./exp/reflow-test/model_400.pt -o ./result/壁上观_tset.wav -k 0 -tw ./raw/壁上观_1.wav
```
